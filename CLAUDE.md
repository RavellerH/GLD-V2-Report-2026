...
- ✅ **AI on-device DIKONFIRMASI (19 Agu, user langsung):** inferensi CNN Dual-Branch **sudah berjalan on-board di ESP32-S3 GLD**, bukan lagi PC+emulator. Ini **menggantikan** status lama `blk:ai-edge` ("belum on-device") — supersede juga larangan lama di bagian 5 ("Jangan klaim AI di edge/on-device"), yang kini sudah bisa diklaim untuk model CNN Dual-Branch.
