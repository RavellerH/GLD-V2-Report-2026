...
| **`05_Update_Instalasi_Cilacap_17September2026/`** | Paket ringkas 7 dokumen (pdf+html) untuk dibagikan cepat (mis. WhatsApp): dashboard proyek keseluruhan, laporan perkembangan field testing &amp; sertifikasi, matriks persiapan instalasi (dgn foto/CAD), daftar persiapan vendor, draf permintaan material ke vendor, dashboard sertifikasi ATEX, dan dokumen teknis sertifikasi (ExCB) — semua client-facing, bebas dari framing internal | Update per 17 Sep — lokasi instalasi permanen sudah dikonfirmasi Pertamina (perimeter SRU) |
