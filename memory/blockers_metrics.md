...
| Test chamber portable | **Sudah dibangun** (dikonfirmasi user, ~awal Sep, dec:49) — dimaksudkan dibawa langsung ke kilang sbg alternatif sampel botolan yg sulit didapat. Dimensi/berat/spek teknis **masih belum diberikan**. ⚠️ Berpotensi perlu rekonsiliasi dgn dec:32 (6 Agu: sampel tidak diambil langsung di kilang) — lih. dec:49. |
