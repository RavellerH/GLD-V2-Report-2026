...
| dec:27 | 6 Agu | Mounting GLD & CH mengikuti pola sistem **Corrosion Monitoring Emerson** yang sudah terpasang: **bracket L + U-clamp** ke tiang/struktur existing, **TIDAK bikin pole baru**, **hindari pengelasan & pengeboran** | Arahan **Raihan Fakhar (RU VII Kasim)**; instalasi harus mudah & cepat, tidak butuh struktur baru |
| dec:28 | 6 Agu | Topologi jaringan GLD diarahkan mengikuti pola corrosion monitoring: node bisa **langsung ke GW (bypass CH)** bila memungkinkan (mesh-tree node discovery), dan **GLD diminta bisa berfungsi juga sebagai CH (repeater)** | Selaras dgn sistem existing di kilang yang sudah teruji & disetujui Pertamina |
| dec:29 | 6 Agu | Logika alarm dibedakan per jenis gas: gas **mudah terbakar** (LPG/Metana dll) → alarm berbasis **threshold ppm** risiko kebakaran; gas **toksik** (CO, H2S) → alarm **LANGSUNG** begitu terdeteksi, tanpa menunggu threshold | Requirement keselamatan Pertamina — risiko kebakaran vs paparan toksik personel butuh penanganan beda |
| dec:30 | 6 Agu | Requirement deteksi gas **bertambah**: **Benzena, CO, H2S** wajib terdeteksi, di luar 6 kelas gate `dec:17` (H₂/LPG/Metana/CO₂/Clean Air) | Requirement eksplisit Pertamina — ⚠️ **BELUM direkonsiliasi**: apakah ini menambah atau menggantikan sebagian gate 6-kelas, perlu klarifikasi ke Pertamina/tim sebelum diupdate ke deliverable gas-capability |
| dec:31 | 6 Agu | Material housing/bracket: **hindari PVC** | Requirement Pertamina, area kritis kilang |
| dec:32 | 6 Agu | Chamber gas **tidak boleh dibawa masuk ke area kilang**; sampel gas dibawa keluar oleh tim Pertamina ke lokasi chamber/lab | Requirement akses & keamanan kilang |
| dec:33 | 6 Agu | Aplikasi dashboard akan ditambah kolom/field **"Area"** pada data equipment & sensor | Requirement Pertamina — perlu tahu sensor/CH milik area mana |
